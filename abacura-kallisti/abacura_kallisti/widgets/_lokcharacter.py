...
class LOKCharacterStatic(Static):
    ...
    def render(self) -> RenderResult:
        ...
        table.add_row(
            f"[cyan]S:[white]{self.c_str} "
            f"[cyan]I:[white]{self.c_int} "
            f"[cyan]W:[white]{self.c_wis} "
            f"[cyan]D:[white]{self.c_dex} "
            f"[cyan]C:[white]{self.c_con} "
            f"[cyan]L:[white]{self.c_luk}\n",
        )
        ...
        table2.add_row(
            "[cyan]XP",
            f"[white]{human_format(self.c_xp)}",
            "[cyan]TNL",
            f"[white]{human_format(self.c_xp_tnl)}",
        )
        table2.add_row(
            "[cyan]Gold",
            f"[white]{human_format(self.c_gold)}",
            "[cyan]Bank",
            f"[white]{human_format(self.c_gold_bank)}",
        )
